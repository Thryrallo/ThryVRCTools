...
namespace Thry
{
    ...
    public class VRC_SdkControlPanel : EditorWindow
    {
        ...
        [MenuItem("Thry/VRC/Build Control Panel")]
        static void InitThry()
        {
            Init();
        }

        [MenuItem("VRChat SDK/Thry/Build Control Panel")]
        static void InitVRC()
        {
            Init();
        }
        ...
        static void Init()
        {
            ...
            window.titleContent.text = "Build VRC";
        ...
        void ShowBuildControls()
        {
            ...
            **/
            ...
            {
                VRCSDK2.VRC_AvatarDescriptor selectedAvatar = null;
                if (Selection.activeGameObject!=null)
                {
                    selectedAvatar = Selection.activeGameObject.GetComponent<VRCSDK2.VRC_AvatarDescriptor>();
                }
                ...
                {
                    if (selectedAvatar != null && av != selectedAvatar) continue;
                    EditorGUI.BeginChangeCheck();
